            ...
            >
              ...
              >
                ...
                <h2 className="text-4xl font-bold mb-4">
                  Bienvenue sur <span className="text-primary">FreeJobGN</span>
                </h2>
            ...
            >
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/80 backdrop-blur-sm text-muted-foreground font-medium">Ou continuer avec</span>
                </div>
              </motion.div>
